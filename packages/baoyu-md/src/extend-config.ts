...
export function loadExtendConfig(): Partial<ExtendConfig> {
  const paths = [
    path.join(process.cwd(), ".kunge2013-skills", "kunge2013-markdown-to-html", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(homedir(), ".config"),
      "kunge2013-skills", "kunge2013-markdown-to-html", "EXTEND.md"
    ),
    path.join(homedir(), ".kunge2013-skills", "kunge2013-markdown-to-html", "EXTEND.md"),
  ];
