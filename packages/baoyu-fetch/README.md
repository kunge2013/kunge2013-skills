...
`kunge2013-fetch` is a Bun CLI built on Chrome CDP. Give it a URL and it returns
...
- Chrome profile defaults to `kunge2013-skills/chrome-profile`
...
```bash
bunx kunge2013-fetch https://example.com
```

You can also install it globally:

```bash
npm install -g kunge2013-fetch
```
...
bunx kunge2013-fetch https://example.com
kunge2013-fetch https://example.com
kunge2013-fetch https://example.com --format markdown --output article.md
kunge2013-fetch https://example.com --format markdown --output article.md --download-media
kunge2013-fetch https://x.com/jack/status/20 --format json --output article.json
kunge2013-fetch https://x.com/jack/status/20 --json
kunge2013-fetch https://x.com/jack/status/20 --wait-for interaction
kunge2013-fetch https://x.com/jack/status/20 --wait-for force
kunge2013-fetch https://x.com/jack/status/20 --chrome-profile-dir ~/Library/Application\\ Support/kunge2013-skills/chrome-profile
```

## Options

```bash
kunge2013-fetch <url> [options]
...
Options:
  ...
  --chrome-profile-dir <path>
                        Chrome user data dir. Defaults to kunge2013_CHROME_PROFILE_DIR
                        or kunge2013-skills/chrome-profile
