# Style Maintenance (kunge2013-comic)

## Adding a New Style

1. Create style definition: `skills/kunge2013-comic/references/styles/<style-name>.md`
2. Update SKILL.md: add to `--style` options table + auto-selection entry
3. Generate showcase image:
   ```bash
   ${BUN_X} skills/kunge2013-danger-gemini-web/scripts/main.ts \
   ...
   ```
4. Compress: `${BUN_X} skills/kunge2013-compress-image/scripts/main.ts screenshots/comic-styles/<style-name>.png`
