...
kunge2013-fetch - Read a URL into Markdown or JSON with Chrome CDP
...
Examples:
  ...
  kunge2013-fetch https://example.com --format json --output article.json
  kunge2013-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for interaction
  kunge2013-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for force
`.trim();
