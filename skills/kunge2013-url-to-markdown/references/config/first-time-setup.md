...
description: First-time setup flow for kunge2013-url-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.kunge2013-skills/kunge2013-url-to-markdown/EXTEND.md` | All projects |
| Project | `.kunge2013-skills/kunge2013-url-to-markdown/EXTEND.md` | Current project |
