---
name: kunge2013-danger-gemini-web
...
- macOS: `~/Library/Application Support/kunge2013-skills/gemini-web/consent.json`
- Linux: `~/.local/share/kunge2013-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\kunge2013-skills\gemini-web\consent.json`
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-danger-gemini-web/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-danger-gemini-web/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-danger-gemini-web/EXTEND.md` | User home |
