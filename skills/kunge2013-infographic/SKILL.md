...
- If `usage: direct` AND the chosen backend accepts reference images (e.g., `kunge2013-imagine` via `--ref`) → pass the file via the backend's ref parameter
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-infographic/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-infographic/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-infographic/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure kunge2013-infographic preferences" / "重新配置"). The next run re-triggers first-time setup.
