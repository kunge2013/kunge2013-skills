...
Structure for user preferences in `.kunge2013-skills/kunge2013-slide-deck/EXTEND.md`.
...
Then use with: `/kunge2013-slide-deck content.md --style style-name`
...
1. `.kunge2013-skills/kunge2013-slide-deck/EXTEND.md` (project)
2. `$HOME/.kunge2013-skills/kunge2013-slide-deck/EXTEND.md` (user)
