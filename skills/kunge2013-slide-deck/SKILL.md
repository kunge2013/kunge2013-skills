...
At generation time, verify files exist. If `usage: direct` and the backend accepts refs (e.g., `kunge2013-imagine --ref`), pass the file on every slide. Otherwise embed extracted `style`/`palette` traits in the prompt text.
...
| Path | Scope |
|------|-------|
| `.kunge2013-skills/kunge2013-slide-deck/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-slide-deck/EXTEND.md` | XDG |
| `$HOME/.kunge2013-skills/kunge2013-slide-deck/EXTEND.md` | User home |
