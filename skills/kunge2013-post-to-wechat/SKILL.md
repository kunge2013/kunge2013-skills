...
| Path | Scope |
|------|-------|
| `.kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` | XDG |
| `$HOME/.kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` | User home |
...
| Profile dir | Shared profile at `kunge2013-skills/chrome-profile` |
...
| API credentials | Follow guided setup in Step 2, or set in `.kunge2013-skills/.env` |
...
**API selected + missing credentials** → run guided setup per `references/api-setup.md` (writes to `.kunge2013-skills/.env`).
