...
3. `.kunge2013-skills/.env` with the prefixed key `WECHAT_{ALIAS}_APP_ID`
4. `~/.kunge2013-skills/.env` with the prefixed key
...
```bash
# Account: kunge2013
WECHAT_kunge2013_APP_ID=your_wechat_app_id
WECHAT_kunge2013_APP_SECRET=your_wechat_app_secret
...
${BUN_X} {baseDir}/scripts/wechat-article.ts --markdown <file> --theme default --account kunge2013
${BUN_X} {baseDir}/scripts/wechat-browser.ts --markdown <file> --images ./photos/ --account kunge2013
```
