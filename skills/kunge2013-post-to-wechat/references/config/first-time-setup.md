...
description: First-time setup flow for kunge2013-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` | All projects |
