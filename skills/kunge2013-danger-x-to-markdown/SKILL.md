---
name: kunge2013-danger-x-to-markdown
...
```bash
# macOS
cat ~/Library/Application\ Support/kunge2013-skills/x-to-markdown/consent.json

# Linux
cat ~/.local/share/kunge2013-skills/x-to-markdown/consent.json
```
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-danger-x-to-markdown/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-danger-x-to-markdown/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-danger-x-to-markdown/EXTEND.md` | User home |
