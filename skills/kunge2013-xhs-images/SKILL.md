...
| Path | Scope |
|------|-------|
| `.kunge2013-skills/kunge2013-image-cards/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-image-cards/EXTEND.md` | XDG |
| `$HOME/.kunge2013-skills/kunge2013-image-cards/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure kunge2013-xhs-images preferences" / "重新配置"). The next run re-triggers first-time setup.
