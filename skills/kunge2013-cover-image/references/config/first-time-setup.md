...
description: First-time setup flow for kunge2013-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.kunge2013-skills/kunge2013-cover-image/EXTEND.md` | Current project |
| User | `~/.kunge2013-skills/kunge2013-cover-image/EXTEND.md` | All projects |
