...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-cover-image/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-cover-image/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-cover-image/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure kunge2013-cover-image preferences" / "重新配置"). The next run re-triggers first-time setup.
