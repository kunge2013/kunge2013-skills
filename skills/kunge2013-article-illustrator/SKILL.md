---
name: kunge2013-article-illustrator
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-article-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-article-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-article-illustrator/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure kunge2013-article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
