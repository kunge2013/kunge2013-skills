...
test -f .kunge2013-skills/kunge2013-article-illustrator/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-article-illustrator/EXTEND.md" && echo "xdg"
test -f "$HOME/.kunge2013-skills/kunge2013-article-illustrator/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .kunge2013-skills/kunge2013-article-illustrator/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/kunge2013-skills/kunge2013-article-illustrator/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.kunge2013-skills/kunge2013-article-illustrator/EXTEND.md") { "user" }
```
...
|------------------------|--------|
| Yes (e.g., kunge2013-imagine with Google) | Pass reference images via `--ref` |
