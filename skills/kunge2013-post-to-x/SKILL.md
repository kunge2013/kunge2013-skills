...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-post-to-x/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-post-to-x/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-post-to-x/EXTEND.md` | User home |
...
| Profile dir | Shared profile at `kunge2013-skills/chrome-profile` (see CLAUDE.md Chrome Profile section) |
