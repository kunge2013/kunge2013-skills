---
name: kunge2013-markdown-to-html
description: Converts Markdown to styled HTML with WeChat-compatible themes. Supports code highlighting, math, PlantUML, footnotes, alerts, infographics, and optional bottom citations for external links. Use when user asks for "markdown to html", "convert md to html", "md 转 html", "微信外链转底部引用", or needs styled HTML output from markdown.
version: 1.56.1
metadata:
  openclaw:
    homepage: https://github.com/kunge2013/kunge2013-skills#kunge2013-markdown-to-html
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-markdown-to-html/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-markdown-to-html/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-markdown-to-html/EXTEND.md` | User home |
...
If CJK content detected AND `kunge2013-format-markdown` skill is available:
...
**If user agrees**: Invoke `kunge2013-format-markdown` skill to format the file, then use formatted file as input.
...
3. `kunge2013-post-to-wechat` EXTEND.md `default_theme` (cross-skill fallback)
...
Read `$HOME/.kunge2013-skills/kunge2013-post-to-wechat/EXTEND.md` if it exists and look for a `default_theme:` line. Use the value if present; otherwise fall through.
