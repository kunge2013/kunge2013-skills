...
description: First-time setup flow for kunge2013-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.kunge2013-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.kunge2013-skills/kunge2013-translate/EXTEND.md` | All projects |
| Project | `.kunge2013-skills/kunge2013-translate/EXTEND.md` | Current project |
