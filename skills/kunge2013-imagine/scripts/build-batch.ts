...
Options:
  ...
  --provider <name>    Provider for kunge2013-imagine batch tasks (default: replicate)
  --model <id>         Explicit model for kunge2013-imagine batch tasks (default: resolved by kunge2013-imagine config/env)
