...
description: First-time setup and default model selection flow for kunge2013-imagine
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.kunge2013-skills/kunge2013-imagine/EXTEND.md` | Current project |
| User | `$HOME/.kunge2013-skills/kunge2013-imagine/EXTEND.md` | All projects |
...
- In `kunge2013-imagine`, Azure `--model` / `default_model.azure` should be the Azure deployment name, not just the underlying model family.
...
- In `kunge2013-imagine`, `quality` is a compatibility preset. It is not a native DashScope parameter.
...
- In `kunge2013-imagine`, Z.AI currently exposes text-to-image only; reference images are not wired for this provider.
...
options:
  - label: "google/nano-banana-2 (Recommended)"
    description: "Current default for general Replicate image generation in kunge2013-imagine"
