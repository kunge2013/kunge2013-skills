...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure kunge2013-image-cards preferences" / "重新配置"). The next run re-triggers first-time setup.
