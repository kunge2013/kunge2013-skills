...
```bash
/kunge2013-comic content.md --storyboard-only
```
...
```bash
/kunge2013-comic content.md --prompts-only
```
...
```bash
/kunge2013-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/kunge2013-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/kunge2013-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/kunge2013-comic comic/topic-slug/ --regenerate 0
```
