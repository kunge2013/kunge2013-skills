...
description: First-time setup flow for kunge2013-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.kunge2013-skills/kunge2013-comic/EXTEND.md` | Current project |
| User | `~/.kunge2013-skills/kunge2013-comic/EXTEND.md` | All projects |
