---
name: kunge2013-format-markdown
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.kunge2013-skills/kunge2013-format-markdown/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/kunge2013-skills/kunge2013-format-markdown/EXTEND.md` | XDG |
| 3 | `$HOME/.kunge2013-skills/kunge2013-format-markdown/EXTEND.md` | User home |
